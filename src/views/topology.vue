        ...
        <el-col :span="8" style="text-align: right">
          <div class="navbar-btns">
            <div v-if="graphMode === 'preview'">
              ...
              <el-button size="mini" @click="handleRefreshClick"
                >刷新</el-button
              >
              <el-dropdown
            ...
            <div v-else-if="graphMode === 'edit'">
              <el-button size="mini" @click="handleLayoutClick"
                >自动布局</el-button
              >
              <el-button size="mini" @click="handlePreviewClick"
                >返回</el-button
              >
              <el-button size="mini" @click="handleGraphDataSave"
                >保存</el-button
              >
            </div>
          </div>
      ...
      nodeTypeList: [
        {
          guid: 'server',
          label: '服务器',
          imgSrc: require('@/assets/images/server.png')
        },
        {
          guid: 'database',
          label: '数据库',
          imgSrc: require('@/assets/images/database.png')
        },
        {
          guid: 'firewall',
          label: '防火墙',
        ...
        },
        {
          guid: 'client',
          label: '客户端',
          imgSrc: require('@/assets/images/client.png')
        }
      ],
      // 节点配置
      nodeAppConfig: {
